...
namespace ProjectC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddTransient<IRequestRuleVariantService, RequestRuleVariantService>();
            ...
            builder.Services.AddTransient<IRequestRuleTriggerService, RequestRuleTriggerService>();
